...
\begin{figure}[tbp]
    \centering\includegraphics{cenca1-daily.pdf}
    \caption{%
...
\begin{figure}[tbp]
    \centering\includegraphics{cenmo1-daily.pdf}
    \caption{%
...
\begin{figure}[tbp]
    \centering\includegraphics{cenqu1-daily.pdf}
    \caption{%
